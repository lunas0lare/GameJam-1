...
class handling_things():
    def __init__(self):
        self.sound = pygame.mixer.Sound('retro-coin-1-236677.mp3')
...
class Game():
    ...
    def __init__(self):
        ...
        self.mob1 = pygame.image.load('trash assets/box tile 32X32 4.png').convert_alpha()
        self.mob2 = pygame.image.load('trash assets/box tile 32X32 3.png').convert_alpha()
        self.mob3 = pygame.image.load('trash assets/box tile 32X32 2.png').convert_alpha()
